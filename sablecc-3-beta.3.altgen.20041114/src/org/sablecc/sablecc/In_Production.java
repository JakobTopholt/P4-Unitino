...
public class In_Production
{
  ...
  public In_Production(AProd prod)
  {
    ...
    AParsedAlt[] alts = (AParsedAlt[])prod.getAlts().toArray(new AParsedAlt[0]);
  ...
  class In_Alternative
  {
    ...
    In_Alternative(AParsedAlt alt, String[] prodTransformElems, String prodName)
    {
	...
	addElem(i, tmpElem );
      ...
      List list = ((AAltTransform)alt.getAltTransform()).getTerms();
