...
public final class AGreaterOrEqualXpathExpr extends PXpathExpr
{
    private PXpathExpr _e1_;
    private PXpathExpr _e2_;

    public AGreaterOrEqualXpathExpr ()
    {
    }
    ...
    public Object clone()
    {
        return new AGreaterOrEqualXpathExpr (
    ...
    {
        ((Analysis) sw).caseAGreaterOrEqualXpathExpr(this);
    }
