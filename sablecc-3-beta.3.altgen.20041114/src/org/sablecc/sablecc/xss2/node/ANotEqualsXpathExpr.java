...
public final class ANotEqualsXpathExpr extends PXpathExpr
{
    private PXpathExpr _e1_;
    private PXpathExpr _e2_;

    public ANotEqualsXpathExpr ()
    {
    }
    ...
    public Object clone()
    {
        return new ANotEqualsXpathExpr (
    ...
    {
        ((Analysis) sw).caseANotEqualsXpathExpr(this);
    }
