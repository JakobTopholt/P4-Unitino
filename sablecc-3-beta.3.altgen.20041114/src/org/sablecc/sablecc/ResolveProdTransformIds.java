 ...
 * for a production(prod {-> prod_0transform1 prod_transform2 prod_transform3...}) 
					...
					type_name += "?";
				      ...
				      if( (node.getUnOp() instanceof AStarUnOp) ||
                                  ...
                                  else
                                  {
                                    ...
                                    Object productions = transformIds.astIds.prods.get("P" + name);
                                    Object ast_production = transformIds.ast_prods.get("P" + name);

                                    if((token == null) && (ast_production == null) && (productions == null))
                                    {
					...
					type_name += "?";
				      ...
				      if( (node.getUnOp() instanceof AStarUnOp) ||
                                    ...
                                    else
                                    {
                                      if(ast_production == null)
                                      {
                                        error6(node.getId(), node.getId().getText());
                                      }
