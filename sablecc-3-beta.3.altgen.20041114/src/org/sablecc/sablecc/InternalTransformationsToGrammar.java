...
public class InternalTransformationsToGrammar extends DepthFirstAdapter
{
  ...
  private List listSimpleTermTransform;
  ...
  private List listElems;
  private AParsedAlt aParsedAlt;
  private List listElemsAltTransform;
  private String currentNewAltName;

  boolean countElementNecessary;

  List listOfAlternativeElemsWHaveName;
  ...
  public void caseAParsedAlt(AParsedAlt node)
  {
    ...
    if(count == 1)
    {
      ...
      aParsedAlt = new AParsedAlt(nameOfAlt, listElems, altTransform);
    ...
    else
    {
      ...
      for(count = 0; count < max; count++)
      {
        ...
        altTransform.apply(altTransformAdapter);
        aParsedAlt = new AParsedAlt(new TId(currentAltName.toLowerCase()+(count + 1)), listElems, altTransform);
  ...
  List checkCreationOfXElem = new TypedLinkedList(StringCast.instance);
      ...
      case STAR:
        {
          ...
          if((count & (1 << elem)) != 0)
          {
            ...
            List tmpProdTransform = (List)mapProductionTransformations.get(qMarkOrPlusElemType);
  ...
  /*
    This method creates the productionfor star(*) and plus(+) substitution in the grammar
    elem* -> $elem |
             elem
  ...
  */
  public AProd createXelemProduction(final String name, final String elemTypeName,
                                     ...
                                     List nodeProdTransform)
  {
    final String rname = name.substring(1);
    List listOfAltsXelem = new LinkedList();

    if(nodeProdTransform != null)
    {
      nodeProdTransform = (List)cloneList(nodeProdTransform);
      ...
      if(nodeProdTransform.size() == 1)
      {
        ...
        {
          List elemsProdTransform = new LinkedList();
    ...
    final List listProdTransformationOfXelem = new LinkedList();
    ...
    final List listTerms_first = new LinkedList();
      ...
      prodTransformElems[i].apply(new AnalysisAdapter()
                                  {
                                    public void caseAElem(AElem node)
                                    {
                                      ...
                                      List listAListTerm_first = new LinkedList();
    ...
    AParsedAlt aParsedAlt = new AParsedAlt(new TId("terminal"), elems, aAltTransform);
    ...
    final List listTerms_second = new LinkedList();
      ...
      prodTransformElems[i].apply(new AnalysisAdapter()
                                  {
                                    public void caseAElem(AElem node)
                                    {
                                      ...
                                      List listAListTerm_second = new LinkedList();
    ...
    aParsedAlt = new AParsedAlt(new TId("non_terminal"), elems, aAltTransform);
