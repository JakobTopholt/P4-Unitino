...
{
  //Map of AST productionds. The AST production node can be obtained
  ...
  //Only Abstract Syntax Tree section is concerned here.
    ...
    prod.apply(new DepthFirstAdapter()
               {
                 public void caseAElem(AElem node)
                 {
                   ...
                   else
                   {
                     ...
                     if((token == null) && (production == null) && (ast_production == null))
                     {
                     ...
                     if(token != null)
                     {
                       if((production != null) || (ast_production != null))
                       {
  ...
  throw new RuntimeException(
    "[" + token.getLine() + "," + token.getPos() + "] " +
    "Only a star operator is allowed in this section ");
  }
  */
