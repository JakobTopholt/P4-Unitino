...
public class ComputeInlining
{
  ...
  public boolean computeInlining()
  {
    ...
    for(int i=0; i<nameOfProds.length; i++)
    {
      ...
      if( !isProductionRecursive(prod) )
      {
        //This class construct a special data structure for the production to inline.
        final In_Production in_production = new In_Production(prod);
    ...
    List listOfGrammarProds = ((AProductions)((AGrammar)tree.getPGrammar()).getProductions()).getProds();
