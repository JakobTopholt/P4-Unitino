...
public final class AStateList extends PStateList
{
    ...
    private final LinkedList _state_lists_ = new TypedLinkedList(new StateLists_Cast());
    ...
    void replaceChild(Node oldChild, Node newChild)
    {
        ...
        for(ListIterator i = _state_lists_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
