...
public final class AProd extends PProd
{
    ...
    private final LinkedList _prod_transform_ = new TypedLinkedList(new ProdTransform_Cast());
    ...
    void removeChild(Node child)
    {
        ...
        if ( _prod_transform_.remove(child))
        {
            return;
        }
    ...
    void replaceChild(Node oldChild, Node newChild)
    {
        ...
        for(ListIterator i = _prod_transform_.listIterator(); i.hasNext();)
        {
            if(i.next() == oldChild)
            {
                if(newChild != null)
